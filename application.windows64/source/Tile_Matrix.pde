...
void setup(){
    ...
    people[1] = new person ( 1 , new PVector( (0.75) * width ,  height / 4 ) , color( 0 , 129 , 255 ) , 87 , 83 , 65 , 68 , 81 ); 
    // 87 -- W
    // 83 -- S
    // 65 -- A
    // 68 -- D
    ...
    people[2] = new person ( 2 , new PVector( (0.75) * width , (0.75) * height ) , color( 255 , 145 , 0 ) , 89 , 72 , 71 , 74 , 84 ); 
    // 89 -- Y
    // 72 -- H
    // 71 -- G
    // 74 -- J
    ...
    people[3] = new person ( 3 , new PVector( width / 4  , (0.75) * height ) , color( 58 , 255 , 0 ) , 80 , 59 , 76 , 222 , 79 ); 
    // 80 -- P
    // 186 -- ;
    // 76 -- l
    // 222 -- '
