...
At the top left and bottom right corners of the matrix, are the Control tiles (in pink). 
Having two players to each step on the control tiles will toggle the step screen between Art Mode and Game Mode. 
